...
const ScrollView = React.forwardRef(({ horizontal, vertical, autoHide, invisible, onScroll, children, style }, ref) => {
  ...
  return (
    <div style={style} onScroll={onScroll} ref={ref} className={`scrollbar${scrollbarClasses}`}>
      {children}
    </div>
  )
})
