...
import {avatarInitials, parseMatrixAccountId, substitutionString} from "../../../../util/common";
    ...
    <MenuItem
      ...
      before={
        <Avatar size="200">
          ...
          >
            <Text size="H6">{avatarInitials(query.text)}</Text>
          </AvatarFallback>
        </Avatar>
      }
    >
          ...
          return (
            <MenuItem
              ...
              after={
                <Text size="T200" priority="300" truncate>
                  {parseMatrixAccountId(roomMember.userId)}
                </Text>
              }
              before={
                <Avatar size="200">
                  {avatarUrl ? (
                    ...
                    >
                      <Text size="H6">{avatarInitials(getName(roomMember))}</Text>
                    </AvatarFallback>
                  )}
                </Avatar>
              }
            >
              <Text style={{ flexGrow: 1 }} size="B400" truncate>
                {substitutionString(getName(roomMember))}
              </Text>
            </MenuItem>
          );
        })
