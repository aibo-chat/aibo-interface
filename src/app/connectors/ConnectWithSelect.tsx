...
function ChainSelect({ activeChainId, switchChain, chainIds }: { activeChainId: number | undefined; switchChain: (chainId: number) => void; chainIds: number[] }) {
  return (
    <select
      value={activeChainId}
      onChange={(event) => {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column' }}>
      ...
      {isActive ? (
        ...
        <button onClick={() => switchChain(desiredChainId)} disabled={isActivating || !desiredChainId}>
