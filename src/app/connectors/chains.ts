...
const getInfuraUrlFor = (network: string) => (import.meta.env.VITE_INFURA_KEY ? `https://${network}.infura.io/v3/${import.meta.env.VITE_INFURA_KEY}` : undefined)
const getAlchemyUrlFor = (network: string) => (import.meta.env.VITE_ALCHEMY_KEY ? `https://${network}.alchemyapi.io/v2/${import.meta.env.VITE_ALCHEMY_KEY}` : undefined)
