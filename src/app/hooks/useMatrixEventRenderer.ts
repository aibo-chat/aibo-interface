...
export type EventRenderer<T extends unknown[]> = (eventId: string, mEvent: MatrixEvent, ...args: T) => ReactNode
...
export type RenderMatrixEvent<T extends unknown[]> = (eventId: string, mEvent: MatrixEvent, ...args: T) => ReactNode
