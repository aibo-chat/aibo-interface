...
import { toggleSystemTheme, toggleNotifications, toggleNotificationSounds } from '../../../client/action/settings'
    ...
    <div className="settings-appearance">
      <div className="settings-appearance__card">
        ...
        {developerMode ? (
          <SettingTile
            ...
            options={<Toggle isActive={twitterEmoji} onToggle={() => setTwitterEmoji(!twitterEmoji)} />}
      ...
      <div className="settings-appearance__card">
        ...
        <SettingTile
          ...
          content={<SegmentedControls selected={messageLayout} segments={[{ text: 'Modern' }, { text: 'Compact' }, { text: 'Bubble' }]} onSelect={(index) => setMessageLayout(index)} />}
        />
        <SettingTile
          ...
          content={
            <SegmentedControls
              ...
              segments={[{ text: 'No' }, { text: 'XXS' }, { text: 'XS' }, { text: 'S' }, { text: 'M' }, { text: 'L' }]}
              onSelect={(index) => {
        ...
        <SettingTile
          ...
          options={<Toggle isActive={enterForNewline} onToggle={() => setEnterForNewline(!enterForNewline)} />}
        ...
        <SettingTile
          ...
          options={<Toggle isActive={hideMembershipEvents} onToggle={() => setHideMembershipEvents(!hideMembershipEvents)} />}
          content={<Text variant="b3">Hide membership change messages from room timeline. (Join, Leave, Invite, Kick and Ban)</Text>}
        />
        <SettingTile
          title="Hide nick/avatar events"
          options={<Toggle isActive={hideNickAvatarEvents} onToggle={() => setHideNickAvatarEvents(!hideNickAvatarEvents)} />}
          content={<Text variant="b3">Hide nick and avatar change messages from room timeline.</Text>}
        />
        <SettingTile
          title="Disable media auto load"
          options={<Toggle isActive={!mediaAutoLoad} onToggle={() => setMediaAutoLoad(!mediaAutoLoad)} />}
        ...
        <SettingTile
          ...
          options={<Toggle isActive={encUrlPreview} onToggle={() => setEncUrlPreview(!encUrlPreview)} />}
          content={<Text variant="b3">Show url preview for link in encrypted messages.</Text>}
        />
        <SettingTile
          title="Show hidden events"
          options={<Toggle isActive={showHiddenEvents} onToggle={() => setShowHiddenEvents(!showHiddenEvents)} />}
...
function NotificationsSection() {
  ...
  const renderOptions = () => {
    ...
    return (
      <Button variant="primary" onClick={() => window.Notification.requestPermission().then(setPermission)}>
        Request permission
      </Button>
    )
  }
  ...
  return (
    <>
      <div className="settings-notifications">
        ...
        <SettingTile title="Desktop notification" options={renderOptions()} content={<Text variant="b3">Show desktop notification when new messages arrive.</Text>} />
        <SettingTile
    ...
    <div className="settings-about">
      <div className="settings-about__card">
        ...
        <div className="settings-about__branding">
          <img width="60" height="60" src={CinnySVG} alt="Defed logo" />
          <div>
            <Text variant="h2" weight="medium">
              Defed
              <span className="text text-b3" style={{ margin: '0 var(--sp-extra-tight)' }}>{`v${cons.version}`}</span>
            </Text>
            <Text>Enjoy encrypted decentralized chat and easy links to your existing social networks.</Text>
          ...
          <div className="settings-about__credits">
            <ul>
              <li>
                ...
                <Text>
                  The{' '}
                  <a href="https://github.com/matrix-org/matrix-js-sdk" rel="noreferrer noopener" target="_blank">
                    matrix-js-sdk
                  </a>{' '}
                  is ©{' '}
              ...
              <li>
                ...
                <Text>
                  The{' '}
                  <a href="https://github.com/mozilla/twemoji-colr" target="_blank" rel="noreferrer noopener">
                    twemoji-colr
                  </a>{' '}
                  font is ©{' '}
              ...
              <li>
                ...
                <Text>
                  The{' '}
                  <a href="https://material.io/design/sound/sound-resources.html" target="_blank" rel="noreferrer noopener">
...
function Settings() {
  ...
  const finalTabItems = useMemo(() => tabItems.filter((item) => !item.developerMode || (item.developerMode && developerMode)), [developerMode])
    ...
    >
      {isOpen && (
        <div className="settings-window__content">
          ...
          <Tabs items={finalTabItems} defaultSelected={tabItems.findIndex((tab) => tab.text === selectedTab.text)} onSelect={handleTabChange} />
