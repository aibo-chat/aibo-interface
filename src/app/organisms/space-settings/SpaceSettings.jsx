...
import { createSpaceShortcut, deleteSpaceShortcut, categorizeSpace, unCategorizeSpace } from '../../../client/action/accountData'
    ...
    <>
      <div className="room-settings__card">
        ...
        <MenuItem
          variant="danger"
          onClick={async () => {
            const isConfirmed = await confirmDialog('Leave space', `Are you sure that you want to leave "${roomName}" space?`, 'Leave', 'danger')
