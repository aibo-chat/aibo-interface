...
async function createRoom(opts) {
  ...
  if (opts.invite?.length) {
    options.invite = opts.invite
  }
  if (opts.conditions?.length) {
    options.room_conditions = opts.conditions
  }
  if (isSpace) {
...
export { convertToDm, convertToRoom, join, leave, createDM, createRoom, invite, kick, ban, unban, ignore, unignore, setPowerLevel, setMyRoomNick, setMyRoomAvatar }
