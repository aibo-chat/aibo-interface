...
import PrivateSpaceIcon from '../../public/res/ic/outlined/private_space_icon.svg'
import PublicSpaceIcon from '../../public/res/ic/outlined/public_space_icon.svg'
import PrivateRoomIcon from '../../public/res/ic/outlined/private_room_icon.svg'
import PublicRoomIcon from '../../public/res/ic/outlined/public_room_icon.svg'
...
export function joinRuleToIconSrc(joinRule, isSpace) {
  return (
    {
      restricted: () => (isSpace ? PublicSpaceIcon : PublicRoomIcon),
      knock: () => (isSpace ? PublicSpaceIcon : PublicRoomIcon),
      invite: () => (isSpace ? PrivateSpaceIcon : PrivateRoomIcon),
      public: () => (isSpace ? PublicSpaceIcon : PublicRoomIcon),
    }[joinRule]?.() || null
  )
}
...
export function genRoomVia(room) {
  ...
  const sortedServers = Object.keys(serverToPop).sort((svrA, svrB) => serverToPop[svrB] - serverToPop[svrA])
